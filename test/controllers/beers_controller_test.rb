...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { big_field: @beer.big_field, description: @beer.description, name: @beer.name }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { big_field: @beer.big_field, description: @beer.description, name: @beer.name }
    assert_redirected_to beer_path(assigns(:beer))
  end
