...
class BikesControllerTest < ActionController::TestCase
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post :create, bike: { big_field: @bike.big_field, description: @bike.description, name: @bike.name }
    end
  ...
  test "should update bike" do
    patch :update, id: @bike, bike: { big_field: @bike.big_field, description: @bike.description, name: @bike.name }
    assert_redirected_to bike_path(assigns(:bike))
  end
