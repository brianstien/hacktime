...
class FoosControllerTest < ActionController::TestCase
  ...
  test "should create foo" do
    assert_difference('Foo.count') do
      post :create, foo: { big_field: @foo.big_field, description: @foo.description, name: @foo.name }
    end
  ...
  test "should update foo" do
    patch :update, id: @foo, foo: { big_field: @foo.big_field, description: @foo.description, name: @foo.name }
    assert_redirected_to foo_path(assigns(:foo))
  end
