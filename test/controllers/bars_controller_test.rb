...
class BarsControllerTest < ActionController::TestCase
  ...
  test "should create bar" do
    assert_difference('Bar.count') do
      post :create, bar: { big_field: @bar.big_field, description: @bar.description, name: @bar.name }
    end
  ...
  test "should update bar" do
    patch :update, id: @bar, bar: { big_field: @bar.big_field, description: @bar.description, name: @bar.name }
    assert_redirected_to bar_path(assigns(:bar))
  end
