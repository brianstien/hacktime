...
class AirplanesControllerTest < ActionController::TestCase
  ...
  test "should create airplane" do
    assert_difference('Airplane.count') do
      post :create, airplane: { big_field: @airplane.big_field, description: @airplane.description, name: @airplane.name }
    end
  ...
  test "should update airplane" do
    patch :update, id: @airplane, airplane: { big_field: @airplane.big_field, description: @airplane.description, name: @airplane.name }
    assert_redirected_to airplane_path(assigns(:airplane))
  end
